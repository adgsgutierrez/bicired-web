                    ...
                    if (o["usr_foto"]) {
                        ...
                        if (o["usr_genero"] == "F") {
                            if (o["tipo"] === "text") {
                                ...
                                var container = "<div  class='card col-centrada' style='width: 70%;height: 300px;margin-top:5px;'><div class='card-body'><div class='row'><div class='col-sm-2' style='text-align:center'><img id='imagen' src='img/perfil-mujer.jpg' style='width:50px;height:50px'/></div><div class='col-sm-5'><h2>" + o["usr_nombre"] + "</h2></div></div><div class='row' style='margin-top:10px;'><div class='col-sm-12' style='text-align:center;'><img src='" + o["mensaje"] + "' style='width:280px;height: 180px;' /></div></div><div class='row'><div id='comentarios_" + o["id_mensaje"] + "' style='margin:auto;'><i class='fa fa-comment-o'> Comentar</i></div></div></div></div>";
                            ...
                            if (o["tipo"] === "text") {
                                ...
                                var container = "<div  class='card col-centrada' style='width: 70%;height: 300px;margin-top:5px;'><div class='card-body'><div class='row'><div class='col-sm-2' style='text-align:center'><img id='imagen' src='img/perfil-hombre.jpg' style='width:50px;height:50px'/></div><div class='col-sm-5'><h2>" + o["usr_nombre"] + "</h2></div></div><div class='row' style='margin-top:10px;'><div class='col-sm-12' style='text-align:center;'><img src='" + o["mensaje"] + "' style='width:280px;height: 180px;' /></div></div><div class='row'><div id='comentarios_" + o["id_mensaje"] + "' style='margin:auto;'><i class='fa fa-comment-o'> Comentar</i></div></div></div></div>";
