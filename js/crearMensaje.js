...
function listamensajes() {
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            $.each(data.datos, function (i, o) {
                if (o["envia"] === correo) {
                    caja2 = "<div class='cajaper' style='width:100%;height:80px;border-bottom: 2px solid darkgray;text-align:right'><label>" + o["mensaje"] + "</label></div>";
                } else {
                    caja2 = "<div class='cajaper' style='width:100%;height:80px;border-bottom: 2px solid darkgray;text-align:left'><label>" + o["mensaje"] + "</label></div>";
                }
